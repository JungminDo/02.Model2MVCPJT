...
<%-- <%
	Purchase product = (Purchase) request.getAttribute("product");
...
<form name="updatePurchase" method="post" action="/updatePurchase.do">
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top: 13px;">
        ...
        <tr>
            ...
            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${purchase.purchaseProd.prodDetail}
            </td>
        </tr>
        <tr>
            <td height="1" colspan="3" bgcolor="D6D6D6"></td>
        ...
        <tr>
            ...
            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${purchase.purchaseProd.manuDate}
            </td>
        </tr>
        <tr>
            <td height="1" colspan="3" bgcolor="D6D6D6"></td>
        ...
        <tr>
            ...
            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${purchase.purchaseProd.price}
            </td>
        </tr>
        <tr>
            <td height="1" colspan="3" bgcolor="D6D6D6"></td>
        ...
        <tr>
            ...
            <td bgcolor="D6D6D6" width="1"></td>
            <td class="ct_write01">${purchase.purchaseProd.regDate}
            </td>
        </tr>
        <tr>
            <td height="1" colspan="3" bgcolor="D6D6D6"></td>
    ...
    <option value="0"  ${ ! empty search.searchCondition && search.searchCondition==0 ? "selected" : "" }>현금구매</option>
	<option value="1"  ${ ! empty search.searchCondition && search.searchCondition==1 ? "selected" : "" }>신용구매</option>
                </select>
            </td>
        </tr>
        <tr>
