		...
		<tr class="ct_list_pop">
			...
			<td></td>
				<td align="left">
					...
					<c:if test="${purchase.tranCode=='1'}"> 판매 중 </c:if>
					<c:if test="${purchase.tranCode=='2'}"> 판매 완료</c:if>
					<c:if test="${purchase.tranCode=='3'}"> 배송 중 </c:if>
					<c:if test="${purchase.tranCode=='4'}"> 배송 완료 </c:if>
